...
{
	echo "<tr><td>". $row["id_g"]. "</td>";
  echo "<td>". $row["gen_g"]. "</td>";
 
  echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['id_g'].">Editar</a></td></tr>";
}
...
$id=$_GET['cambiar'];
		...
		$sql = "SELECT * FROM genero WHERE id_g=".$id;
...
<html>
	...
	<p>ID:
	<input type="text" disabled="disabled" align="LEFT" name="bol" value="<?php echo $registro['id_g'];?>" /><p>
	<p>GENERO:
	<input type="text" align="LEFT" name="car" value="<?php echo $registro['gen_g'];?>"/><p>
	
	
	<input type="submit" value="Actualizar" name="actualizar">
	</form></div>
	<div align="center"><p><a href="editgen.php">EDITAR OTRO REGISTRO</a></p></div>
