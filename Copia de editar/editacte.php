...
{
	echo "<tr><td>". $row["id_acte"]. "</td>";
  echo "<td>". $row["tipo_acte"]. "</td>";
 
  echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['id_acte'].">Editar</a></td></tr>";
}
...
$id=$_GET['cambiar'];
		...
		$sql = "SELECT * FROM acte WHERE id_acte=".$id;
...
<html>
	...
	<p>ID:
	<input type="text" disabled="disabled" align="LEFT" name="bol" value="<?php echo $registro['id_acte'];?>" /><p>
	<p>AACTIVIDAD:
	<input type="text" align="LEFT" name="car" value="<?php echo $registro['tipo_acte'];?>"/><p>
	
	
	<input type="submit" value="Actualizar" name="actualizar">
	</form></div>
	<div align="center"><p><a href="editacte.php">EDITAR OTRO REGISTRO</a></p></div>
