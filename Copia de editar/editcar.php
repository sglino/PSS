...
$id=$_GET['cambiar'];
		...
		$sql = "SELECT * FROM carrera WHERE id_c=".$id;
...
<html>
	...
	<p>ID:
	<input type="text" disabled="disabled" align="LEFT" name="bol" value="<?php echo $registro['id_c'];?>" /><p>
	<p>CARRERA:
	<input type="text" align="LEFT" name="car" value="<?php echo $registro['nom_c'];?>"/><p>
	
	
	<input type="submit" value="Actualizar" name="actualizar">
	</form></div>
	<div align="center"><p><a href="editcar.php">EDITAR OTRO REGISTRO</a></p></div>
