...
while ($row=mysql_fetch_array ($resultado))
{
  ...
  echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['id_e'].">Editar</a></td></tr>";
}
...
$id=$_GET['cambiar'];
		...
		$sql = "SELECT * FROM enfermedad WHERE id_e=".$id;
...
<html>
	...
	<p>ID:
	<input type="text" disabled="disabled" align="LEFT" name="bol" value="<?php echo $registro['id_e'];?>" /><p>
	<p>ENFERMEDAD:
	<input type="text" align="LEFT" name="car" value="<?php echo $registro['tipo_e'];?>"/><p>
	
	
	<input type="submit" value="Actualizar" name="actualizar">
	</form></div>
	<div align="center"><p><a href="editenf.php">EDITAR OTRO REGISTRO</a></p></div>
