...
{
	echo "<tr><td>". $row["id_es"]. "</td>";
  echo "<td>". $row["nom_es"]. "</td>";
 
  echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['id_es'].">Editar</a></td></tr>";
}
...
$id=$_GET['cambiar'];
		...
		$sql = "SELECT * FROM estatus WHERE id_es=".$id;
...
<html>
	...
	<p>ID:
	<input type="text" disabled="disabled" align="LEFT" name="bol" value="<?php echo $registro['id_es'];?>" /><p>
	<p>ESTATUS:
	<input type="text" align="LEFT" name="car" value="<?php echo $registro['nom_es'];?>"/><p>
	
	
	<input type="submit" value="Actualizar" name="actualizar">
	</form></div>
	<div align="center"><p><a href="editest.php">EDITAR OTRO REGISTRO</a></p></div>
