    ...
    <nav class="navegacion">
      <ul class="menu">
        ...
        <li><a href="../BORRAR/borrar_enf.php">Eliminar</a>
		  ...
		  <li><a href="../INSERTAR/insertar_enfernedad.php">Insertar</a></li>
...
?>
    ...
    <h1 id="titulo">  MODIFICAR ENFERMEDAD </h1> </header>
    <div align="center">
...
while ($row=mysqli_fetch_array($resultado1)){
	...
	echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['ID_ENF'].">Editar</a></td></tr>";
}
?>
	</table></div></form>
	</body>
...
$id=$_GET['cambiar'];
		...
		include ("conexion1.php");
		$con = connect();
		$consulta = "SELECT * FROM ".$tabla." WHERE ID_ENF=".$id;
...
?>
	...
	<form action="<?php echo $_SERVER['PHP_self'];?>" method="post" name="modificar_enfermedad.php">
<!-- 7. CAMBIAR LOS NOMBRES Y LOS VALORES COMO EN SQL -->
	<p>			
	<input type="hidden" align="LEFT" name="ID_ENF" value="<?php echo $registro['ID_ENF'];?>" /><p>
		<br><h2>Modifique los datos con cuidado y al terminar presione GUARDAR<br> </h2>
<br><br>
	<p>NOMBRE:
	<input type="text" align="LEFT" name="NOM_ENF" value="<?php echo $registro['NOM_ENF'];?>"/><p><br><br>
	...
	<div align="center"><p><a href="modificar_enfermedad.php">Volver</a></p></div>
...
$subs_A = utf8_decode($_POST['ID_ENF']);
$subs_B = utf8_decode($_POST['NOM_ENF']);
