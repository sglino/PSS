...
?>
    ...
    <body>
    	<header>
		<h1 id="titulo">  ELIMINAR ACTIVIDAD EXTRA </h1> </header>
 		<div align="center">
...
<?php
	...
	echo "<td><a href=".$_SERVER['PHP_SELF']."?borrar=".$row['ID_ACTEXT'].">Borrar</a></td></tr>";
	}
?>
	</table></div></form>
	</body>
...
<?php
		include ("conexion1.php");
		$con = connect();
		$consulta="DELETE FROM ".$tabla." WHERE ID_ACTEXT=".$id;
